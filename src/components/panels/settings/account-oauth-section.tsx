...
/** Shows Google OAuth connection status with a disconnect action. */
export function AccountOAuthSection() {
  ...
  const handleDisconnect = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Brief delay so the user sees the feedback before reload
