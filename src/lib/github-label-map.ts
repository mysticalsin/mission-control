/**
 * Bidirectional mapping between Ultron Mission Control statuses/priorities and GitHub labels.
...
const STATUS_LABEL_MAP: Record<TaskStatus, LabelDef> = {
  inbox:          { name: 'mc:inbox',          color: '6b7280', description: 'Ultron Mission Control: inbox' },
  assigned:       { name: 'mc:assigned',       color: '3b82f6', description: 'Ultron Mission Control: assigned' },
  in_progress:    { name: 'mc:in-progress',    color: 'eab308', description: 'Ultron Mission Control: in progress' },
  review:         { name: 'mc:review',         color: 'a855f7', description: 'Ultron Mission Control: review' },
  quality_review: { name: 'mc:quality-review', color: '6366f1', description: 'Ultron Mission Control: quality review' },
  done:           { name: 'mc:done',           color: '22c55e', description: 'Ultron Mission Control: done' },
}
